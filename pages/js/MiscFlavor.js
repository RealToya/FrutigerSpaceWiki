/*Effects or Auxiliary code for the Website needs to be maintained here */
...
document.addEventListener('DOMContentLoaded', () => {  
    ...
    const glassElements = document.querySelectorAll('.topic-folder, .sidebar-box, .ko-fi-button, .box, .dev-card'); // Add more selectors as needed
